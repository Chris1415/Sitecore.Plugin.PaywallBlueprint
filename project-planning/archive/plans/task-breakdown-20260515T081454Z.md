...
- **Post-T006 inline `.d.ts` citations — captured 2026-05-15 against stripe@22.1.1; paths under `site/node_modules/stripe/cjs/resources/` (NOT a `types/` subdirectory — stripe@22.x changed layout; `types/` path assumed by architect does NOT exist):**
  - `stripe.checkout.sessions.create` — request: `// source: node_modules/stripe/cjs/resources/Checkout/Sessions.d.ts → Checkout.SessionCreateParams (re-exported as Stripe.Checkout.SessionCreateParams via node_modules/stripe/cjs/resources/Checkout/index.d.ts)`; response: `// source: node_modules/stripe/cjs/resources/Checkout/Sessions.d.ts → Session (re-exported as Stripe.Checkout.Session)`
  - `stripe.customers.list` — request: `// source: node_modules/stripe/cjs/resources/Customers.d.ts → CustomerListParams`; response: `// source: node_modules/stripe/cjs/lib.d.ts → ApiList<Customer>`
  - `stripe.customers.create` — request: `// source: node_modules/stripe/cjs/resources/Customers.d.ts → CustomerCreateParams`; response: `// source: node_modules/stripe/cjs/resources/Customers.d.ts → Customer`
  - `stripe.customers.update` — request: `// source: node_modules/stripe/cjs/resources/Customers.d.ts → CustomerUpdateParams`; response: `// source: node_modules/stripe/cjs/resources/Customers.d.ts → Customer`
  - `stripe.customers.retrieve` — `// source: node_modules/stripe/cjs/resources/Customers.d.ts → Customer | DeletedCustomer`
  - `stripe.webhooks.constructEvent` — `// source: node_modules/stripe/cjs/Webhooks.d.ts → constructEvent(payload, header, secret, ...) → Event` (throws on bad sig; `Event` is re-exported from Events.d.ts)
  - `Stripe.Event` (discriminated union) — `// source: node_modules/stripe/cjs/resources/Events.d.ts:174 → type Event = ... union of ~200 named event interfaces`
  - `CheckoutSessionCompletedEvent` — `// source: node_modules/stripe/cjs/resources/Events.d.ts:685 → interface CheckoutSessionCompletedEvent extends EventBase { type: 'checkout.session.completed'; data: { object: Session } }` — NOTE: NOT namespaced as `Stripe.Checkout.SessionCompletedEvent`; correct name is `CheckoutSessionCompletedEvent`
  - `CheckoutSessionAsyncPaymentSucceededEvent` — `// source: node_modules/stripe/cjs/resources/Events.d.ts:672` — NOTE: architect preview listed `Stripe.AsyncPaymentSucceededEvent`; actual name is `CheckoutSessionAsyncPaymentSucceededEvent`
  - `CheckoutSessionAsyncPaymentFailedEvent` — `// source: node_modules/stripe/cjs/resources/Events.d.ts:659` — NOTE: architect preview listed `Stripe.AsyncPaymentFailedEvent`; actual name is `CheckoutSessionAsyncPaymentFailedEvent`
  - `CustomerSubscriptionUpdatedEvent` — `// source: node_modules/stripe/cjs/resources/Events.d.ts:1088` — NOTE: architect preview listed `Stripe.SubscriptionUpdatedEvent`; actual name is `CustomerSubscriptionUpdatedEvent`
  - `CustomerSubscriptionDeletedEvent` — `// source: node_modules/stripe/cjs/resources/Events.d.ts:1010` — NOTE: architect preview listed `Stripe.SubscriptionDeletedEvent`; actual name is `CustomerSubscriptionDeletedEvent`
  - `InvoicePaymentFailedEvent` — `// source: node_modules/stripe/cjs/resources/Events.d.ts:1517` — name matches architect preview
  - `stripe.billingPortal.sessions.create` (PRD-003 stub) — `// source: node_modules/stripe/cjs/resources/BillingPortal/Sessions.d.ts → BillingPortal.SessionCreateParams (re-exported as Stripe.BillingPortal.SessionCreateParams via node_modules/stripe/cjs/resources/BillingPortal/index.d.ts)`
  - **IMPORTANT TYPE NAME CORRECTIONS for Tranche B/C/D implementation:** use the actual SDK names (`CheckoutSessionCompletedEvent`, `CustomerSubscriptionUpdatedEvent`, `CustomerSubscriptionDeletedEvent`, `CheckoutSessionAsyncPaymentSucceededEvent`, `CheckoutSessionAsyncPaymentFailedEvent`) — NOT the architect's preview names (`Stripe.Checkout.SessionCompletedEvent`, `Stripe.SubscriptionUpdatedEvent`, etc.). The `event.type` string discriminants are unchanged: `'checkout.session.completed'`, `'customer.subscription.updated'`, etc.
